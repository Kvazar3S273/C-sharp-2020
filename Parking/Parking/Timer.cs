...
namespace Parking
{
    class Timer
    {
        ...
        public Timer()
        {
            ...
            DateTime rangeEndIn = new DateTime(2020, 7, 4, 23, 59, 0);     //кіннець діапазону дат заїзду
            DateTime rangeStartOut = new DateTime(2020, 7, 5, 9, 12, 1);   //початок діапазону дат виїзду з парковки
            DateTime rangeEndOut = new DateTime(2020, 7, 6, 22, 16, 50);   //кіннець діапазону дат виїзду
        ...
        {
            this.OverdueTime = this.FromParkingTime - this.ToParkingTime - this.PayTime;
            return OverdueTime;
        }
